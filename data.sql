USE teachua;
 ...
 create table `feedbacks` (`id` bigint not null auto_increment, `date` datetime(6), `rate` float(23) not null, text varchar(255), `user_name` varchar(255), `club_id` bigint, `user_id` bigint, primary key (`id`)) engine=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin; create table `news` (`id` bigint not null auto_increment, date datetime(6), description varchar(255), title varchar(255) not null, url_title_logo varchar(255), primary key (id)) engine=InnoDB  DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
